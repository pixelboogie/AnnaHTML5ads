...
var vid_cta2Out			= document.querySelector("#vid_cta1Out");
...
var vid_contTime = 10.0; // 12.3/24f = 12.125-.2
...
vid_tl
	...
	.from(vid_tt, 1, {scale:.9, transformOrigin:"80% 90%", ease:Elastic.easeOut}, 0)
